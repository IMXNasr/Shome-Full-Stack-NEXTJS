...
// 	const show = await (await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/shows/${context.params?.id}?type=${context.params?.type}`)).data;
// 	if (show.error) {
// 		return {
// 			notFound: true,
// 		};
// 	}
// 	const actors = await (await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/acts/${context.params?.id}?for=show`)).data;
// 	return {
// 		props: {
// 			show: show.show,
// 			actors,
