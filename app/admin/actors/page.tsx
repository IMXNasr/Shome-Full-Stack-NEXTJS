...
const ShowsPage = async () => {
	...
	const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/actors`);
...
// 		return {
// 			redirect: {
// 				destination: "/login?redirect=admin/actors",
// 				permanent: false,
// 			},
// 		};
// 	}
...
// 		};
// 	}
// 	const { data } = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/actors`);
// 	return {
// 		props: {
// 			actors: data,
// 		},
